...
SECRET_KEY = 'django-insecure-lxz=wqj11l*@%tr+o*^*_cw&78sh0i=g*!pw#m#sbe9*!(-4u*'
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'cart.context_processors.cart_count',  # Add your custom context processor here
            ],
        },
    },
]
